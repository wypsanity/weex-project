<template>
    <!-- good-grid -->
    <div>
         <div class="newproduct-section" v-if="categoryGoodss.length>0" v-for="item in categoryGoodss">
            <div>
            <text class="type-title font-md">{{item.name}}</text>
            </div>
            <div class="layout-box">
                <div class="popular-box" v-for="good in item.goodsList">
                    <div class="new-image-box">
                        <image class="new-image" :src="good.listPicUrl" resize="stretch"></image>
                    </div>
                ...
                <div class="txtdiv">
                    ...
                    <image class="icon" src="../../../src/static/images/icon_go_more.png" resize="stretch"></image>
                </div>
            </div>
         </div>
    </div>
